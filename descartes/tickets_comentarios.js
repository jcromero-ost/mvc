document.addEventListener("DOMContentLoaded", function () {
    ...
    nuevoComentarioBtn.addEventListener('click', function() {
        ...
        // Crear un span para mostrar el usuario que ha creado el comentario
        const usuarioComentario = document.createElement('span');
        usuarioComentario.classList.add('block', 'mt-2', 'text-sm', 'text-gray-500');
        usuarioComentario.textContent = 'Usuario';

        // Agregar el textarea y la fecha al div contenedor
        comentarioIndividualDiv.appendChild(fechaHora);
        comentarioIndividualDiv.appendChild(usuarioComentario);
