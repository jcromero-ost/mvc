<!-- Modal Comentario con Editor Quill (unificado) -->
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content border-0 shadow">
      ...
      <div class="modal-body">
        <!-- Campo oculto para guardar el ID del comentario (si ya existe) -->
        <input type="hidden" id="comentarioId" value="<?= $comentario_id ?? '' ?>" />

        <!-- Contenedor del editor Quill -->
        <div id="editorQuill" style="height: 200px;"></div>

        <!-- Campo oculto para guardar el HTML del comentario -->
